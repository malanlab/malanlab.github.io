...
- Posteromedial regions → sensory-discriminative processing  
- Prefrontal / orbitofrontal cortex → subjective pain intensity  
...
### Problem
The cerebellum is essential for motor learning and error correction, but cerebello–cortical interaction during real-time motor error processing in humans remains unclear.

### What we study
We investigate cerebello–cortical communication using:

- EEG/MEG recordings  
- Motor error paradigms  
- Connectivity and oscillatory coupling  
- Computational modeling  

### Key questions
- How does the cerebellum transmit error signals to cortex?  
- Which cortical regions encode motor updates?  
- How does learning reshape these interactions?  
...
### Problem
Freezing of gait (FOG) in Parkinson’s disease arises from transient motor block, but its network-level mechanism remains unclear.

### What we study
We use:

- EEG and Local Field Potentials (LFP)  
- Deep brain stimulation (DBS) recordings  
- Motor task paradigms  
- Beta burst dynamics  
- Functional connectivity analysis  

### Key hypotheses
- FOG reflects **disrupted cortico–basal ganglia communication**
- Abnormal **beta bursts** reflect impaired motor state switching
- DBS restores network dynamics and motor flow  

### Interpretation
FOG is a **network failure of motor state transitions**, involving cortical and subcortical circuits modulated by DBS.
